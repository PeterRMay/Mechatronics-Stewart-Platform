function jointAngles = StewartPlatformEqs_JointAngles(T,Phi, armLegRatio, platformBaseRatio, legRestingLength, platformRadius, servoMotorRange, plotBool, displayWarnings)
    arguments
        T
        Phi
        armLegRatio
